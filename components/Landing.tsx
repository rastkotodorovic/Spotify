...
export default function Landing() {
    ...
    return (
        <div className="px-4 mt-6 sm:px-6 lg:px-8">
            <h2 className="text-gray-600 text-sm font-medium tracking-wide mx-4">Featured playlists</h2>
            <ul
                role="list"
            ...
            <h2 className="text-gray-600 text-sm font-medium tracking-wide mx-4">My playlists</h2>
            <ul
                role="list"
