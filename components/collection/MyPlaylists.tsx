...
export default function MyPlaylists() {
    ...
    return (
        <div className="px-4 mt-6 sm:px-6 lg:px-8">
            <h2 className="text-gray-600 text-md font-medium tracking-wide mx-4">Playlists</h2>
            <ul
                role="list"
            ...
            >
                <div className="bg-gray-100 w-64 shadow-lg rounded p-2">
                    <div className="group relative">
                        <img alt="Placeholder" className="block h-48 w-full rounded"  src="https://storage.needpix.com/rsynced_images/green-heart-1465690358vQc.jpg" />
                    ...
                    <div className="p-2">
                        <h3 className="text-gray-600 py-1 text-base justify-center">Liked songs</h3>
                        <p className="text-gray-400 text-sm">My liked songs</p>
                    </div>
                </div>
